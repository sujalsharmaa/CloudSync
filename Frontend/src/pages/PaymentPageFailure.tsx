...
// --- CANCELLATION PAGE COMPONENT ---
export const PaymentCancelled: FC<{ onNavigateHome: () => void; }> = ({ onNavigateHome }) => (
  <BaseStatusPage
    title="Payment Cancelled"
    message="Your transaction could not be completed. Please check your payment details or try again later."
    icon={XCircle}
    iconClass="bg-red-600/50 border border-red-500/80"
...
  return (
    <PaymentCancelled onNavigateHome={handleHomeNavigation} />
  );
}
